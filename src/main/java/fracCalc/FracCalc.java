...
public class FracCalc {
	...
	int firstpacketNumberator=Integer.parseInt(numerator(firstpacket));
...
return("whole:"+secondpacketWhole+" " +"numerator:"+secondpacketNumerator+" "+"denominator:"+secondpacketDenominator);
	}
